...
## Code hardening
- Sat Sep 26, 2026 ET — SharePointLibraryAutoZip: path traversal hardening (`safe_join` + basename/containment). SharePointListPullAuto: OData filter datetime validation before interpolation.
